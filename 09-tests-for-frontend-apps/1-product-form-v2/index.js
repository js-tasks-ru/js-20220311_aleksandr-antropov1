...
export default class ProductForm {
  ...
  initEventListeners() {
    ...
    this.subElements.uploadImageButton.addEventListener(
      "click",
      this.fileUploader.showModal
    );
  ...
  serializeForm() {
    ...
    if (imageUrlInputs !== undefined && imageSourceInputs !== undefined) {
      result.images = Array.from(imageUrlInputs).reduce(
        (previousValue, imageUrlInput, index) => {
